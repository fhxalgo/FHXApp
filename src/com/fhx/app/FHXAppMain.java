 ...
 */
	...
	public Integer[] imageIds = { R.drawable.hong_1, R.drawable.gong_1,
			R.drawable.ji_1, R.drawable.lu_1, R.drawable.wei_1,
			R.drawable.ba_1, R.drawable.yi_1, R.drawable.tou_1,
			R.drawable.zuan_1, R.drawable.dao_1, R.drawable.di_2,
			R.drawable.di_1, R.drawable.xia_1 };
 ...
 */
	...
	public void addNewImageToScreen(int resourceId) {
		...
		if (imageHolder != null) {
			...
			newView.setImageResource(imageIds[resourceId]);
